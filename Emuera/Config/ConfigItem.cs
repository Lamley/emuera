...
namespace MinorShift.Emuera
{
    internal abstract class AConfigItem
    {
        ...
        public static ConfigItem<T> Copy<T>(ConfigItem<T> other)
        {
            if (other == null)
                return null;
            var ret = new ConfigItem<T>(other.Code, other.Text, other.Value);
    ...
    internal sealed class ConfigItem<T> : AConfigItem
    {
        ...
        public override string ValueToString()
        {
            if (this is ConfigItem<bool>)
            {
                ...
                var b = ((ConfigItem<bool>) (AConfigItem) this).Value;
                if (b)
                    return "YES";
                return "NO";
            }
            ...
            {
                var c = ((ConfigItem<Color>) (AConfigItem) this).Value;
