...
namespace MinorShift.Emuera.Forms
{
    ...
    internal partial class ConfigDialog : Form
    {
        ...
        {
            var item = (ConfigItem<bool>) ConfigData.Instance.GetConfigItem(code);
        ...
        {
            var item = (ConfigItem<int>) ConfigData.Instance.GetConfigItem(code);
        ...
        {
            var item = (ConfigItem<Color>) ConfigData.Instance.GetConfigItem(code);
        ...
        {
            var item = (ConfigItem<string>) ConfigData.Instance.GetConfigItem(code);
        ...
        public void SetConfig(MainWindow mainWindow)
        {
            ...
            switch (itemTDM.Value)
            {
                case TextDrawingMode.WINAPI:
                    comboBoxTextDrawingMode.SelectedIndex = 0;
                    break;
                case TextDrawingMode.TEXTRENDERER:
                    comboBoxTextDrawingMode.SelectedIndex = 1;
                    break;
                case TextDrawingMode.GRAPHICS:
                    comboBoxTextDrawingMode.SelectedIndex = 2;
                    break;
            }
            comboBoxTextDrawingMode.Enabled = !itemTDM.Fixed;

            var itemStr = (ConfigItem<string>) ConfigData.Instance.GetConfigItem(ConfigCode.FontName);
            var fontname = itemStr.Value;
            var nameIndex = comboBox2.Items.IndexOf(fontname);
            if (nameIndex >= 0)
            ...
            var itemRA =
                (ConfigItem<ReduceArgumentOnLoadFlag>) ConfigData.Instance.GetConfigItem(
                    ConfigCode.ReduceArgumentOnLoad);
            switch (itemRA.Value)
            {
                case ReduceArgumentOnLoadFlag.NO:
                    comboBoxReduceArgumentOnLoad.SelectedIndex = 0;
                    break;
                case ReduceArgumentOnLoadFlag.ONCE:
                    comboBoxReduceArgumentOnLoad.SelectedIndex = 1;
                    break;
                case ReduceArgumentOnLoadFlag.YES:
                    comboBoxReduceArgumentOnLoad.SelectedIndex = 2;
                    break;
            }
            comboBoxReduceArgumentOnLoad.Enabled = !itemRA.Fixed;


            var itemInt = (ConfigItem<int>) ConfigData.Instance.GetConfigItem(ConfigCode.DisplayWarningLevel);
            if (itemInt.Value <= 0)
            ...
            var itemDWF =
                (ConfigItem<DisplayWarningFlag>) ConfigData.Instance.GetConfigItem(ConfigCode.FunctionNotFoundWarning);
            ...
            itemDWF = (ConfigItem<DisplayWarningFlag>) ConfigData.Instance.GetConfigItem(ConfigCode
            ...
            var itemLang = (ConfigItem<UseLanguage>) ConfigData.Instance.GetConfigItem(ConfigCode.useLanguage);
            ...
            var itemET = (ConfigItem<TextEditorType>) ConfigData.Instance.GetConfigItem(ConfigCode.EditorType);
            switch (itemET.Value)
            {
        ...
        {
            var config = ConfigData.Instance.Copy();
            ...
            var nameIndex = comboBox2.SelectedIndex;
            if (nameIndex >= 0)
            ...
            {
                case 0:
                    config.GetConfigItem(ConfigCode.TextDrawingMode).SetValue(TextDrawingMode.WINAPI);
                    break;
                case 1:
                    config.GetConfigItem(ConfigCode.TextDrawingMode).SetValue(TextDrawingMode.TEXTRENDERER);
                    break;
                case 2:
                    config.GetConfigItem(ConfigCode.TextDrawingMode).SetValue(TextDrawingMode.GRAPHICS);
                    break;
            }
            ...
            {
                case 0:
                    config.GetConfigItem(ConfigCode.ReduceArgumentOnLoad).SetValue(ReduceArgumentOnLoadFlag.NO);
                    break;
                case 1:
                    config.GetConfigItem(ConfigCode.ReduceArgumentOnLoad).SetValue(ReduceArgumentOnLoadFlag.ONCE);
                    break;
                case 2:
                    config.GetConfigItem(ConfigCode.ReduceArgumentOnLoad).SetValue(ReduceArgumentOnLoadFlag.YES);
                    break;
            }
            ...
            {
                case 0:
                    config.GetConfigItem(ConfigCode.FunctionNotFoundWarning).SetValue(DisplayWarningFlag.IGNORE);
                    break;
                case 1:
                    config.GetConfigItem(ConfigCode.FunctionNotFoundWarning).SetValue(DisplayWarningFlag.LATER);
                    break;
                case 2:
                    config.GetConfigItem(ConfigCode.FunctionNotFoundWarning).SetValue(DisplayWarningFlag.ONCE);
                    break;
                case 3:
                    config.GetConfigItem(ConfigCode.FunctionNotFoundWarning).SetValue(DisplayWarningFlag.DISPLAY);
                    break;
            }
            switch (comboBox4.SelectedIndex)
            {
                case 0:
                    config.GetConfigItem(ConfigCode.FunctionNotCalledWarning).SetValue(DisplayWarningFlag.IGNORE);
                    break;
                case 1:
                    config.GetConfigItem(ConfigCode.FunctionNotCalledWarning).SetValue(DisplayWarningFlag.LATER);
                    break;
                case 2:
                    config.GetConfigItem(ConfigCode.FunctionNotCalledWarning).SetValue(DisplayWarningFlag.ONCE);
                    break;
                case 3:
                    config.GetConfigItem(ConfigCode.FunctionNotCalledWarning).SetValue(DisplayWarningFlag.DISPLAY);
                    break;
            }
            switch (comboBox1.SelectedIndex)
            {
                case 0:
                    config.GetConfigItem(ConfigCode.useLanguage).SetValue(UseLanguage.JAPANESE);
                    break;
                case 1:
                    config.GetConfigItem(ConfigCode.useLanguage).SetValue(UseLanguage.KOREAN);
                    break;
                case 2:
                    config.GetConfigItem(ConfigCode.useLanguage).SetValue(UseLanguage.CHINESE_HANS);
                    break;
                case 3:
                    config.GetConfigItem(ConfigCode.useLanguage).SetValue(UseLanguage.CHINESE_HANT);
                    break;
            }
            switch (comboBox6.SelectedIndex)
            {
                case 0:
                    config.GetConfigItem(ConfigCode.EditorType).SetValue(TextEditorType.SAKURA);
                    break;
                case 1:
                    config.GetConfigItem(ConfigCode.EditorType).SetValue(TextEditorType.TERAPAD);
                    break;
                case 2:
                    config.GetConfigItem(ConfigCode.EditorType).SetValue(TextEditorType.EMEDITOR);
                    break;
                case 3:
                    config.GetConfigItem(ConfigCode.EditorType).SetValue(TextEditorType.USER_SETTING);
                    break;
            }
        ...
        private int setCheckBoxChecked(CheckBox checkbox, bool flag)
        {
        ...
        private int setComboBoxChanged(ComboBox combobox, int value)
        {
