...
namespace MinorShift.Emuera.GameData.Expression
{
    ...
    internal static class OperatorMethodManager
    {
        private static readonly Dictionary<OperatorCode, OperatorMethod> unaryDic =
            new Dictionary<OperatorCode, OperatorMethod>();
        ...
        {
            OperatorMethod method = null;
            if (o1.GetOperandType() == typeof(long) && o2.GetOperandType() == typeof(long) &&
                o3.GetOperandType() == typeof(long))
                method = ternaryIntIntInt;
            else if (o1.GetOperandType() == typeof(long) && o2.GetOperandType() == typeof(string) &&
        ...
        private sealed class DivIntInt : OperatorMethod
        {
            ...
            public override long GetIntValue(ExpressionMediator exm, IOperandTerm[] arguments)
            {
                var right = arguments[1].GetIntValue(exm);
                if (right == 0)
        ...
        private sealed class GreaterStrStr : OperatorMethod
        {
            ...
            public override long GetIntValue(ExpressionMediator exm, IOperandTerm[] arguments)
            {
                var c = string.Compare(arguments[0].GetStrValue(exm), arguments[1].GetStrValue(exm),
                    Config.SCExpression);
                if (c > 0)
                    return 1L;
                return 0L;
        ...
        private sealed class XorIntInt : OperatorMethod
        {
            ...
            public override long GetIntValue(ExpressionMediator exm, IOperandTerm[] arguments)
            {
                var i1 = arguments[0].GetIntValue(exm);
                var i2 = arguments[1].GetIntValue(exm);
        ...
        private sealed class IncrementInt : OperatorMethod
        {
            ...
            public override long GetIntValue(ExpressionMediator exm, IOperandTerm[] arguments)
            {
                var var = (VariableTerm) arguments[0];
