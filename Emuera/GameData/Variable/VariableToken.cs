...
namespace MinorShift.Emuera.GameData.Variable
{
    ...
    internal abstract class VariableToken
    {
        ...
        {
            Code = varCode;
            VariableType = (varCode & VariableCode.__INTEGER__) == VariableCode.__INTEGER__
                ? typeof(long)
                : typeof(string);
                     ...
                     && !varName.StartsWith("NOTUSE_"))
            {
                var flag = Code & (VariableCode.__ARRAY_1D__ | VariableCode.__ARRAY_2D__ | VariableCode.__ARRAY_3D__ |
                                   ...
                                   VariableCode.__CHARACTER_DATA__);
                switch (flag)
                {
        ...
        public virtual void IsArrayRangeValid(long[] arguments, long index1, long index2, string funcName, long i1,
            long i2)
        {
            CheckElement(arguments, new[] {true, true, true});
        }
    ...
    internal abstract class CharaVariableToken : VariableToken
    {
        ...
        public override void IsArrayRangeValid(long[] arguments, long index1, long index2, string funcName, long i1,
            long i2)
        {
            CheckElement(arguments);
            var chara = varData.CharacterList[(int) arguments[0]];
    ...
    internal abstract class UserDefinedCharaVariableToken : CharaVariableToken
    {
        ...
        protected UserDefinedCharaVariableToken(VariableCode varCode, UserDefinedVariableData data,
            VariableData varData, int arrayIndex)
            : base(varCode, varData)
        {
...
//Defaultのセットは参照元がやるべき
    ...
    internal sealed partial class VariableData
    {
        ...
        private sealed class CharaInt1DVariableToken : CharaVariableToken
        {
            ...
            public override object GetArrayChara(int charano)
            {
                var chara = varData.CharacterList[charano];
        ...
        private sealed class CharaInt2DVariableToken : CharaVariableToken
        {
            ...
            {
                var chara = varData.CharacterList[(int) arguments[0]];
                var array = chara.DataIntegerArray2D[VarCodeInt];
                var start = (int) arguments[2];
                var end = start + values.Length;
                var index1 = (int) arguments[1];
                for (var i = start; i < end; i++)
        ...
        private sealed class CharaStr2DVariableToken : CharaVariableToken
        {
            ...
            {
                var chara = varData.CharacterList[(int) arguments[0]];
                var array = chara.DataStringArray2D[VarCodeInt];
                var start = (int) arguments[2];
                var end = start + values.Length;
                var index1 = (int) arguments[1];
                for (var i = start; i < end; i++)
        ...
        private sealed class Debug__FILE__Token : PseudoVariableToken
        {
            ...
            public override string GetStrValue(ExpressionMediator exm, long[] arguments)
            {
                var line = exm.Process.GetScaningLine();
        ...
        {
            private readonly string[] array;
            private readonly string[] defArray;
        ...
        {
            public UserDefinedCharaInt1DVariableToken(UserDefinedVariableData data, VariableData varData,
                int arrayIndex)
            ...
            public override long GetIntValue(ExpressionMediator exm, long[] arguments)
            {
                var array = (long[]) GetArrayChara((int) arguments[0]);
            ...
            public override void SetValueAll(long value, int start, int end, int charaPos)
            {
                var array = (long[]) GetArrayChara(charaPos);
                for (var i = start; i < end; i++)
                    array[i] = value;
            }
        ...
        {
            public UserDefinedCharaStr1DVariableToken(UserDefinedVariableData data, VariableData varData,
                int arrayIndex)
            ...
            public override string GetStrValue(ExpressionMediator exm, long[] arguments)
            {
                var array = (string[]) GetArrayChara((int) arguments[0]);
                return array[arguments[1]];
            }
            ...
            public override void SetValueAll(string value, int start, int end, int charaPos)
            {
                var array = (string[]) GetArrayChara(charaPos);
                for (var i = start; i < end; i++)
                    array[i] = value;
            }
        }
        ...
        {
            public UserDefinedCharaInt2DVariableToken(UserDefinedVariableData data, VariableData varData,
                int arrayIndex)
        ...
        {
            public UserDefinedCharaStr2DVariableToken(UserDefinedVariableData data, VariableData varData,
                int arrayIndex)
